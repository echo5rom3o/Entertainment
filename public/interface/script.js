	...
	Object.defineProperty(List.prototype,"render",{writable:true,configurable:true,value:function(){"use strict";
		...
		return React.createElement("div", null, 
			...
			React.createElement("select", {onChange: this.setLimit}, 
				React.createElement("option", {selected: true}, "30"), 
			...
			React.createElement("button", {onClick: this.load}, "Load More")
		);
	}});
...
function Item(props){
	return React.createElement("tr", null, 
		...
		React.createElement("td", null, React.createElement("a", {href: "/linkredirect/?url="+   props.url}, props.release)), 
		React.createElement("td", null, props.group)
	);
}
...
function LoadList(){
	...
	React.createElement("h3", null, "Latest List"), 
		React.createElement(List, {list: data.latestlist}), 
	React.createElement("h3", null, "Popular List"), 
		React.createElement(List, {list: data.popularlist}), 
	React.createElement("h3", null, "Suggested List"), 
		React.createElement(List, {list: data.suggestedlist})
	)
}
