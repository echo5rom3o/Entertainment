...
var ____Class4=React.Component;for(var ____Class4____Key in ____Class4){if(____Class4.hasOwnProperty(____Class4____Key)){Link[____Class4____Key]=____Class4[____Class4____Key];}}var ____SuperProtoOf____Class4=____Class4===null?null:____Class4.prototype;Link.prototype=Object.create(____SuperProtoOf____Class4);Link.prototype.constructor=Link;Link.__superConstructor__=____Class4;
	...
	Object.defineProperty(Link.prototype,"onset",{writable:true,configurable:true,value:function(event){"use strict";
	...
	Object.defineProperty(Link.prototype,"render",{writable:true,configurable:true,value:function(){"use strict";
		...
		return React.createElement("form", {action: "link", method: "post", onSubmit: this.onset}, 
			...
			React.createElement("label", null, "Release:"), React.createElement("input", {placeholder: "1", name: "release", type: "text"}), React.createElement("br", null), 
			React.createElement("label", null, "Channel/Author/Translator:"), 
			React.createElement("input", {name: "group", type: "text"}), 
			React.createElement("br", null), 
			React.createElement("input", {type: "submit"}), React.createElement("br", null), 
			React.createElement("img", {width: "50px", height: "50px", src: "interface/SafeBrowsing_Icon.png"}), 
			React.createElement("span", null, React.createElement("a", {href: "https://developers.google.com/safe-browsing"}, "Scanned With Google Safe Browse")), 
			React.createElement("span", {className: "warning"}, data.link)
		);
	}});

ReactDOM.render([React.createElement(Header, null),React.createElement("main", null, React.createElement(Link, null))],document.getElementById("container"))
